...
const ConvertArrayToObject = (array: KeyValuePair[]): KeyValueObject => {
  const filteredArray = array.filter(
    (pair) => pair.key !== "" && pair.value !== "" && pair.checked === true,
  );
  return filteredArray.reduce<KeyValueObject>(
...
const useSendRequest = (
  paramsArray: KeyValuePair[] | undefined,
  headersArray: KeyValuePair[] | undefined,
  url: string,
  method: HttpVerb,
